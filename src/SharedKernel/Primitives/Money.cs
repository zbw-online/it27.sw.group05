...
namespace SharedKernel.Primitives
{
    public sealed class Money : ValueObject
    {
        ...
        /// <summary>
        /// Defines the components used for value equality comparison.
        /// Two Money instances are equal if both Amount and Currency match exactly.
        /// Used by ValueObject base class Equals() and GetHashCode() implementations.
        /// </summary>
