...
namespace OrderManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260830193814_AddDeliveryDateAndBillingAddressToOrders")]
    partial class AddDeliveryDateAndBillingAddressToOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderManagement.Domain.Orders.OrderLine", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("OrderLinesHistory");
                                ttb
                                    .HasPeriodStart("RowValidFrom")
                                    .HasColumnName("RowValidFrom");
                                ttb
            ...
            modelBuilder.Entity("OrderManagement.Domain.Orders.Order", b =>
                {
                    ...
                    b.OwnsOne("SharedKernel.Primitives.Address", "DeliveryAddress", b1 =>
                        {
                            b1.Property<int>("OrderId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManagement.Domain.Orders.OrderLine", b =>
                {
                    ...
                    b.OwnsOne("SharedKernel.Primitives.Money", "LineTotal", b1 =>
                        {
                    ...
                    b.OwnsOne("SharedKernel.Primitives.Money", "UnitPrice", b1 =>
                        {
                            b1.Property<int>("OrderLineId")
                                .HasColumnType("int");
